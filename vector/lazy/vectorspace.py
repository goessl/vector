...
def veclpos(v:Iterable) -> Generator:
...
def veclneg(v:Iterable) -> Generator:
...
def vecladd(*vs:Iterable) -> Generator:
    r"""Return the sum.
...
def vecladdc(v:Iterable, c:Any, i:int=0, zero:Any=0) -> Generator:
...
def veclsub(v:Iterable, w:Iterable) -> Generator:
...
def veclsubc(v:Iterable, c:Any, i:int=0, zero:Any=0) -> Generator:
...
def veclmul(v:Iterable, a:Any) -> Generator:
...
def veclrmul(a:Any, v:Iterable) -> Generator:
    r"""Return the product.
...
def vecltruediv(v:Iterable, a:Any) -> Generator:
...
def veclfloordiv(v:Iterable, a:Any) -> Generator:
...
def veclmod(v:Iterable, a:Any) -> Generator:
...
def vecldivmod(v:Iterable, a:Any) -> Generator[tuple[Any,Any]]:
    ...
    $$
    """
    yield from map(divmod, v, repeat(a))
